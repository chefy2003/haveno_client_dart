...
final $typed_data.Uint8List accountExistsRequestDescriptor =
    $convert.base64Decode('ChRBY2NvdW50RXhpc3RzUmVxdWVzdA==');
...
final $typed_data.Uint8List isAccountOpenRequestDescriptor =
    $convert.base64Decode('ChRJc0FjY291bnRPcGVuUmVxdWVzdA==');
...
final $typed_data.Uint8List createAccountReplyDescriptor =
    $convert.base64Decode('ChJDcmVhdGVBY2NvdW50UmVwbHk=');
...
final $typed_data.Uint8List openAccountReplyDescriptor =
    $convert.base64Decode('ChBPcGVuQWNjb3VudFJlcGx5');
...
final $typed_data.Uint8List isAppInitializedRequestDescriptor =
    $convert.base64Decode('ChdJc0FwcEluaXRpYWxpemVkUmVxdWVzdA==');
...
final $typed_data.Uint8List changePasswordReplyDescriptor =
    $convert.base64Decode('ChNDaGFuZ2VQYXNzd29yZFJlcGx5');
...
final $typed_data.Uint8List closeAccountReplyDescriptor =
    $convert.base64Decode('ChFDbG9zZUFjY291bnRSZXBseQ==');
...
final $typed_data.Uint8List deleteAccountReplyDescriptor =
    $convert.base64Decode('ChJEZWxldGVBY2NvdW50UmVwbHk=');
...
final $typed_data.Uint8List backupAccountRequestDescriptor =
    $convert.base64Decode('ChRCYWNrdXBBY2NvdW50UmVxdWVzdA==');
...
final $typed_data.Uint8List backupAccountReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List restoreAccountReplyDescriptor =
    $convert.base64Decode('ChNSZXN0b3JlQWNjb3VudFJlcGx5');
...
final $typed_data.Uint8List getDisputesRequestDescriptor =
    $convert.base64Decode('ChJHZXREaXNwdXRlc1JlcXVlc3Q=');
...
final $typed_data.Uint8List openDisputeRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List openDisputeReplyDescriptor =
    $convert.base64Decode('ChBPcGVuRGlzcHV0ZVJlcGx5');
...
final $typed_data.Uint8List resolveDisputeReplyDescriptor =
    $convert.base64Decode('ChNSZXNvbHZlRGlzcHV0ZVJlcGx5');
...
const ResolveDisputeRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.io.haveno.protobuffer.DisputeResult.Reason',
      '10': 'reason'
    },
...
final $typed_data.Uint8List sendDisputeChatMessageRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List sendDisputeChatMessageReplyDescriptor =
    $convert.base64Decode('ChtTZW5kRGlzcHV0ZUNoYXRNZXNzYWdlUmVwbHk=');
...
final $typed_data.Uint8List registerDisputeAgentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List registerDisputeAgentReplyDescriptor =
    $convert.base64Decode('ChlSZWdpc3RlckRpc3B1dGVBZ2VudFJlcGx5');
...
final $typed_data.Uint8List unregisterDisputeAgentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List unregisterDisputeAgentReplyDescriptor =
    $convert.base64Decode('ChtVbnJlZ2lzdGVyRGlzcHV0ZUFnZW50UmVwbHk=');
...
final $typed_data.Uint8List registerNotificationListenerRequestDescriptor =
    $convert
        .base64Decode('CiNSZWdpc3Rlck5vdGlmaWNhdGlvbkxpc3RlbmVyUmVxdWVzdA==');
...
const NotificationMessage$json = {
  ...
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.io.haveno.protobuffer.NotificationMessage.NotificationType',
      '10': 'type'
    },
    ...
    {'1': 'message', '3': 5, '4': 1, '5': 9, '10': 'message'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.TradeInfo',
      '10': 'trade'
    },
    {
      '1': 'chat_message',
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.NotificationMessage',
      '10': 'notification'
    },
  ],
};
...
final $typed_data.Uint8List sendNotificationReplyDescriptor =
    $convert.base64Decode('ChVTZW5kTm90aWZpY2F0aW9uUmVwbHk=');
...
const UrlConnection$json = {
  ...
  '2': [
    ...
    {'1': 'priority', '3': 4, '4': 1, '5': 5, '10': 'priority'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.io.haveno.protobuffer.UrlConnection.OnlineStatus',
      '10': 'onlineStatus'
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.io.haveno.protobuffer.UrlConnection.AuthenticationStatus',
      '10': 'authenticationStatus'
    },
  ],
  '4': [
    UrlConnection_OnlineStatus$json,
    UrlConnection_AuthenticationStatus$json
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.UrlConnection',
      '10': 'connection'
    },
  ],
};
...
final $typed_data.Uint8List addConnectionReplyDescriptor =
    $convert.base64Decode('ChJBZGRDb25uZWN0aW9uUmVwbHk=');
...
final $typed_data.Uint8List removeConnectionRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List removeConnectionReplyDescriptor =
    $convert.base64Decode('ChVSZW1vdmVDb25uZWN0aW9uUmVwbHk=');
...
final $typed_data.Uint8List getConnectionRequestDescriptor =
    $convert.base64Decode('ChRHZXRDb25uZWN0aW9uUmVxdWVzdA==');
...
final $typed_data.Uint8List setConnectionReplyDescriptor =
    $convert.base64Decode('ChJTZXRDb25uZWN0aW9uUmVwbHk=');
...
final $typed_data.Uint8List checkConnectionRequestDescriptor =
    $convert.base64Decode('ChZDaGVja0Nvbm5lY3Rpb25SZXF1ZXN0');
...
@$core.Deprecated('Use getBestConnectionRequestDescriptor instead')
const GetBestConnectionRequest$json = {
  '1': 'GetBestConnectionRequest',
};

/// Descriptor for `GetBestConnectionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getBestConnectionRequestDescriptor =
    $convert.base64Decode('ChhHZXRCZXN0Q29ubmVjdGlvblJlcXVlc3Q=');

@$core.Deprecated('Use getBestConnectionReplyDescriptor instead')
const GetBestConnectionReply$json = {
  '1': 'GetBestConnectionReply',
  '2': [
    {
      '1': 'connection',
      '3': 1,
...
/// Descriptor for `GetBestConnectionReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getBestConnectionReplyDescriptor =
    $convert.base64Decode(
        'ChZHZXRCZXN0Q29ubmVjdGlvblJlcGx5EkQKCmNvbm5lY3Rpb24YASABKAsyJC5pby5oYXZlbm'
        '8ucHJvdG9idWZmZXIuVXJsQ29ubmVjdGlvblIKY29ubmVjdGlvbg==');
...
final $typed_data.Uint8List setAutoSwitchReplyDescriptor =
    $convert.base64Decode('ChJTZXRBdXRvU3dpdGNoUmVwbHk=');
...
final $typed_data.Uint8List getAutoSwitchRequestDescriptor =
    $convert.base64Decode('ChRHZXRBdXRvU3dpdGNoUmVxdWVzdA==');
...
final $typed_data.Uint8List isXmrNodeOnlineRequestDescriptor =
    $convert.base64Decode('ChZJc1htck5vZGVPbmxpbmVSZXF1ZXN0');
...
final $typed_data.Uint8List getXmrNodeSettingsRequestDescriptor =
    $convert.base64Decode('ChlHZXRYbXJOb2RlU2V0dGluZ3NSZXF1ZXN0');
...
final $typed_data.Uint8List getXmrNodeSettingsReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List startXmrNodeReplyDescriptor =
    $convert.base64Decode('ChFTdGFydFhtck5vZGVSZXBseQ==');
...
final $typed_data.Uint8List stopXmrNodeRequestDescriptor =
    $convert.base64Decode('ChJTdG9wWG1yTm9kZVJlcXVlc3Q=');
...
final $typed_data.Uint8List stopXmrNodeReplyDescriptor =
    $convert.base64Decode('ChBTdG9wWG1yTm9kZVJlcGx5');
...
final $typed_data.Uint8List getOfferRequestDescriptor =
    $convert.base64Decode('Cg9HZXRPZmZlclJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.OfferInfo',
      '10': 'offer'
    },
  ],
};
...
final $typed_data.Uint8List getMyOfferRequestDescriptor =
    $convert.base64Decode('ChFHZXRNeU9mZmVyUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
...
const PostOfferRequest$json = {
  ...
  '2': [
    ...
    {
      '1': 'security_deposit_pct',
      '3': 8,
      '4': 1,
      '5': 1,
      '10': 'securityDepositPct'
    },
    ...
    {'1': 'is_private_offer', '3': 12, '4': 1, '5': 8, '10': 'isPrivateOffer'},
    {
      '1': 'buyer_as_taker_without_deposit',
      '3': 13,
      '4': 1,
      '5': 8,
      '10': 'buyerAsTakerWithoutDeposit'
    },
    {'1': 'extra_info', '3': 14, '4': 1, '5': 9, '10': 'extraInfo'},
    {'1': 'source_offer_id', '3': 15, '4': 1, '5': 9, '10': 'sourceOfferId'},
  ],
};
...
final $typed_data.Uint8List postOfferRequestDescriptor = $convert.base64Decode(
    ...
    'QSMAoUc2VjdXJpdHlfZGVwb3NpdF9wY3QYCCABKAFSEnNlY3VyaXR5RGVwb3NpdFBjdBIjCg10'
    'cmlnZ2VyX3ByaWNlGAkgASgJUgx0cmlnZ2VyUHJpY2USMAoUcmVzZXJ2ZV9leGFjdF9hbW91bn'
    'QYCiABKAhSEnJlc2VydmVFeGFjdEFtb3VudBIsChJwYXltZW50X2FjY291bnRfaWQYCyABKAlS'
    'EHBheW1lbnRBY2NvdW50SWQSKAoQaXNfcHJpdmF0ZV9vZmZlchgMIAEoCFIOaXNQcml2YXRlT2'
    'ZmZXISQgoeYnV5ZXJfYXNfdGFrZXJfd2l0aG91dF9kZXBvc2l0GA0gASgIUhpidXllckFzVGFr'
    'ZXJXaXRob3V0RGVwb3NpdBIdCgpleHRyYV9pbmZvGA4gASgJUglleHRyYUluZm8SJgoPc291cm'
    'NlX29mZmVyX2lkGA8gASgJUg1zb3VyY2VPZmZlcklk');
...
@$core.Deprecated('Use editOfferRequestDescriptor instead')
const EditOfferRequest$json = {
  '1': 'EditOfferRequest',
  '2': [
    ...
    {'1': 'trigger_price', '3': 6, '4': 1, '5': 9, '10': 'triggerPrice'},
    {
      '1': 'payment_account_id',
      '3': 7,
      '4': 1,
    ...
    {'1': 'extra_info', '3': 8, '4': 1, '5': 9, '10': 'extraInfo'},
  ],
};

/// Descriptor for `EditOfferRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List editOfferRequestDescriptor = $convert.base64Decode(
    'ChBFZGl0T2ZmZXJSZXF1ZXN0EhkKCG9mZmVyX2lkGAEgASgJUgdvZmZlcklkEiMKDWN1cnJlbm'
    'N5X2NvZGUYAiABKAlSDGN1cnJlbmN5Q29kZRIUCgVwcmljZRgDIAEoCVIFcHJpY2USMwoWdXNl'
    'X21hcmtldF9iYXNlZF9wcmljZRgEIAEoCFITdXNlTWFya2V0QmFzZWRQcmljZRI1ChdtYXJrZX'
    'RfcHJpY2VfbWFyZ2luX3BjdBgFIAEoAVIUbWFya2V0UHJpY2VNYXJnaW5QY3QSIwoNdHJpZ2dl'
    'cl9wcmljZRgGIAEoCVIMdHJpZ2dlclByaWNlEiwKEnBheW1lbnRfYWNjb3VudF9pZBgHIAEoCV'
    'IQcGF5bWVudEFjY291bnRJZBIdCgpleHRyYV9pbmZvGAggASgJUglleHRyYUluZm8=');

@$core.Deprecated('Use editOfferReplyDescriptor instead')
const EditOfferReply$json = {
  '1': 'EditOfferReply',
  '2': [
    {
      '1': 'offer',
...
/// Descriptor for `EditOfferReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List editOfferReplyDescriptor = $convert.base64Decode(
    'Cg5FZGl0T2ZmZXJSZXBseRI2CgVvZmZlchgBIAEoCzIgLmlvLmhhdmVuby5wcm90b2J1ZmZlci'
    '5PZmZlckluZm9SBW9mZmVy');

@$core.Deprecated('Use deactivateOfferRequestDescriptor instead')
const DeactivateOfferRequest$json = {
  '1': 'DeactivateOfferRequest',
  '2': [
    {'1': 'offer_id', '3': 1, '4': 1, '5': 9, '10': 'offerId'},
  ],
};

/// Descriptor for `DeactivateOfferRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deactivateOfferRequestDescriptor =
    $convert.base64Decode(
        'ChZEZWFjdGl2YXRlT2ZmZXJSZXF1ZXN0EhkKCG9mZmVyX2lkGAEgASgJUgdvZmZlcklk');

@$core.Deprecated('Use deactivateOfferReplyDescriptor instead')
const DeactivateOfferReply$json = {
  '1': 'DeactivateOfferReply',
};

/// Descriptor for `DeactivateOfferReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deactivateOfferReplyDescriptor =
    $convert.base64Decode('ChREZWFjdGl2YXRlT2ZmZXJSZXBseQ==');

@$core.Deprecated('Use activateOfferRequestDescriptor instead')
const ActivateOfferRequest$json = {
  '1': 'ActivateOfferRequest',
  '2': [
    {'1': 'offer_id', '3': 1, '4': 1, '5': 9, '10': 'offerId'},
  ],
};

/// Descriptor for `ActivateOfferRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List activateOfferRequestDescriptor =
    $convert.base64Decode(
        'ChRBY3RpdmF0ZU9mZmVyUmVxdWVzdBIZCghvZmZlcl9pZBgBIAEoCVIHb2ZmZXJJZA==');

@$core.Deprecated('Use activateOfferReplyDescriptor instead')
const ActivateOfferReply$json = {
  '1': 'ActivateOfferReply',
};

/// Descriptor for `ActivateOfferReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List activateOfferReplyDescriptor =
    $convert.base64Decode('ChJBY3RpdmF0ZU9mZmVyUmVwbHk=');
...
final $typed_data.Uint8List cancelOfferRequestDescriptor =
    $convert.base64Decode('ChJDYW5jZWxPZmZlclJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
...
final $typed_data.Uint8List cancelOfferReplyDescriptor =
    $convert.base64Decode('ChBDYW5jZWxPZmZlclJlcGx5');
...
const OfferInfo$json = {
  ...
  '2': [
    ...
    {
      '1': 'payment_method_short_name',
      '3': 18,
      '4': 1,
      '5': 9,
      '10': 'paymentMethodShortName'
    },
    {
    ...
    {'1': 'challenge', '3': 33, '4': 1, '5': 9, '10': 'challenge'},
    {'1': 'extra_info', '3': 34, '4': 1, '5': 9, '10': 'extraInfo'},
    {
    ...
    {
      '1': 'accepted_countries_string',
      '3': 36,
      '4': 1,
      '5': 9,
      '10': 'acceptedCountriesString'
    },
    {'1': 'city', '3': 37, '4': 1, '5': 9, '10': 'city'},
  ],
};
...
final $typed_data.Uint8List offerInfoDescriptor = $convert.base64Decode(
    ...
    'dE91dHB1dFR4RmVlEigKEGlzX3ByaXZhdGVfb2ZmZXIYICABKAhSDmlzUHJpdmF0ZU9mZmVyEh'
    'wKCWNoYWxsZW5nZRghIAEoCVIJY2hhbGxlbmdlEh0KCmV4dHJhX2luZm8YIiABKAlSCWV4dHJh'
    'SW5mbxI0ChZhY2NlcHRlZF9jb3VudHJ5X2NvZGVzGCMgAygJUhRhY2NlcHRlZENvdW50cnlDb2'
    'RlcxI6ChlhY2NlcHRlZF9jb3VudHJpZXNfc3RyaW5nGCQgASgJUhdhY2NlcHRlZENvdW50cmll'
    'c1N0cmluZxISCgRjaXR5GCUgASgJUgRjaXR5');
...
final $typed_data.Uint8List availabilityResultWithDescriptionDescriptor =
    $convert.base64Decode(
...
const CreatePaymentAccountRequest$json = {
  ...
  '2': [
    {
      '1': 'payment_account_form',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.PaymentAccountForm',
      '10': 'paymentAccountForm'
    },
    {
      '1': 'payment_account_form_as_json',
      '3': 2,
      '4': 1,
      '5': 9,
      '10': 'paymentAccountFormAsJson'
    },
  ],
};
...
final $typed_data.Uint8List createPaymentAccountReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getPaymentAccountsRequestDescriptor =
    $convert.base64Decode('ChlHZXRQYXltZW50QWNjb3VudHNSZXF1ZXN0');
...
final $typed_data.Uint8List getPaymentMethodsRequestDescriptor =
    $convert.base64Decode('ChhHZXRQYXltZW50TWV0aG9kc1JlcXVlc3Q=');
...
final $typed_data.Uint8List getPaymentMethodsReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getPaymentAccountFormReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getPaymentAccountFormAsJsonRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getPaymentAccountFormAsJsonReplyDescriptor =
    $convert.base64Decode(
...
@$core.Deprecated(
    'Use createCryptoCurrencyPaymentAccountRequestDescriptor instead')
...
final $typed_data.Uint8List
    createCryptoCurrencyPaymentAccountRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List deletePaymentAccountRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List deletePaymentAccountReplyDescriptor =
    $convert.base64Decode('ChlEZWxldGVQYXltZW50QWNjb3VudFJlcGx5');

@$core
    .Deprecated('Use createCryptoCurrencyPaymentAccountReplyDescriptor instead')
...
final $typed_data.Uint8List createCryptoCurrencyPaymentAccountReplyDescriptor =
    $convert.base64Decode(
...
@$core
    .Deprecated('Use getCryptoCurrencyPaymentMethodsRequestDescriptor instead')
...
final $typed_data.Uint8List getCryptoCurrencyPaymentMethodsRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getCryptoCurrencyPaymentMethodsReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List validateFormFieldReplyDescriptor =
    $convert.base64Decode('ChZWYWxpZGF0ZUZvcm1GaWVsZFJlcGx5');
...
final $typed_data.Uint8List marketPriceReplyDescriptor = $convert
    .base64Decode('ChBNYXJrZXRQcmljZVJlcGx5EhQKBXByaWNlGAEgASgBUgVwcmljZQ==');
...
final $typed_data.Uint8List marketPricesRequestDescriptor =
    $convert.base64Decode('ChNNYXJrZXRQcmljZXNSZXF1ZXN0');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.io.haveno.protobuffer.MarketPriceInfo',
      '10': 'marketPrice'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.MarketDepthInfo',
      '10': 'marketDepth'
    },
  ],
};
...
final $typed_data.Uint8List getTradeStatisticsRequestDescriptor =
    $convert.base64Decode('ChlHZXRUcmFkZVN0YXRpc3RpY3NSZXF1ZXN0');
...
final $typed_data.Uint8List stopReplyDescriptor =
    $convert.base64Decode('CglTdG9wUmVwbHk=');
...
final $typed_data.Uint8List takeOfferRequestDescriptor = $convert.base64Decode(
    ...
    'UgZhbW91bnQSHAoJY2hhbGxlbmdlGAQgASgJUgljaGFsbGVuZ2U=');
...
const TakeOfferReply$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.AvailabilityResultWithDescription',
      '10': 'failureReason'
    },
  ],
};
...
final $typed_data.Uint8List confirmPaymentSentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List confirmPaymentSentReplyDescriptor =
    $convert.base64Decode('ChdDb25maXJtUGF5bWVudFNlbnRSZXBseQ==');
...
final $typed_data.Uint8List confirmPaymentReceivedRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List confirmPaymentReceivedReplyDescriptor =
    $convert.base64Decode('ChtDb25maXJtUGF5bWVudFJlY2VpdmVkUmVwbHk=');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.io.haveno.protobuffer.GetTradesRequest.Category',
      '10': 'category'
    },
  ],
...
final $typed_data.Uint8List completeTradeRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List completeTradeReplyDescriptor =
    $convert.base64Decode('ChJDb21wbGV0ZVRyYWRlUmVwbHk=');
...
final $typed_data.Uint8List withdrawFundsReplyDescriptor =
    $convert.base64Decode('ChJXaXRoZHJhd0Z1bmRzUmVwbHk=');
...
final $typed_data.Uint8List getChatMessagesRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List sendChatMessageRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List sendChatMessageReplyDescriptor =
    $convert.base64Decode('ChRTZW5kQ2hhdE1lc3NhZ2VSZXBseQ==');
...
const TradeInfo$json = {
  ...
  '2': [
    ...
    {
      '1': 'trade_peer_node_address',
      '3': 19,
      '4': 1,
      '5': 9,
      '10': 'tradePeerNodeAddress'
    },
    ...
    {
      '1': 'is_deposits_published',
      '3': 25,
      '4': 1,
      '5': 8,
      '10': 'isDepositsPublished'
    },
    {
      '1': 'is_deposits_confirmed',
      '3': 26,
      '4': 1,
      '5': 8,
      '10': 'isDepositsConfirmed'
    },
    {
      '1': 'is_deposits_unlocked',
      '3': 27,
      '4': 1,
      '5': 8,
      '10': 'isDepositsUnlocked'
    },
    {
      '1': 'is_deposits_finalized',
      '3': 43,
      '4': 1,
      '5': 8,
      '10': 'isDepositsFinalized'
    },
    {'1': 'is_payment_sent', '3': 28, '4': 1, '5': 8, '10': 'isPaymentSent'},
    {
      '1': 'is_payment_received',
      '3': 29,
      '4': 1,
      '5': 8,
      '10': 'isPaymentReceived'
    },
    {
      '1': 'is_payout_published',
      '3': 30,
      '4': 1,
      '5': 8,
      '10': 'isPayoutPublished'
    },
    {
      '1': 'is_payout_confirmed',
      '3': 31,
      '4': 1,
      '5': 8,
      '10': 'isPayoutConfirmed'
    },
    {
      '1': 'is_payout_unlocked',
      '3': 32,
      '4': 1,
      '5': 8,
      '10': 'isPayoutUnlocked'
    ...
    {
      '1': 'is_payout_finalized',
      '3': 44,
      '4': 1,
      '5': 8,
      '10': 'isPayoutFinalized'
    },
    ...
    {'1': 'contract_as_json', '3': 34, '4': 1, '5': 9, '10': 'contractAsJson'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.ContractInfo',
      '10': 'contract'
    },
    ...
    {'1': 'start_time', '3': 40, '4': 1, '5': 4, '10': 'startTime'},
    {'1': 'max_duration_ms', '3': 41, '4': 1, '5': 4, '10': 'maxDurationMs'},
    {'1': 'deadline_time', '3': 42, '4': 1, '5': 4, '10': 'deadlineTime'},
  ],
};
...
final $typed_data.Uint8List tradeInfoDescriptor = $convert.base64Decode(
    ...
    'EmlzRGVwb3NpdHNVbmxvY2tlZBIyChVpc19kZXBvc2l0c19maW5hbGl6ZWQYKyABKAhSE2lzRG'
    'Vwb3NpdHNGaW5hbGl6ZWQSJgoPaXNfcGF5bWVudF9zZW50GBwgASgIUg1pc1BheW1lbnRTZW50'
    'Ei4KE2lzX3BheW1lbnRfcmVjZWl2ZWQYHSABKAhSEWlzUGF5bWVudFJlY2VpdmVkEi4KE2lzX3'
    'BheW91dF9wdWJsaXNoZWQYHiABKAhSEWlzUGF5b3V0UHVibGlzaGVkEi4KE2lzX3BheW91dF9j'
    'b25maXJtZWQYHyABKAhSEWlzUGF5b3V0Q29uZmlybWVkEiwKEmlzX3BheW91dF91bmxvY2tlZB'
    'ggIAEoCFIQaXNQYXlvdXRVbmxvY2tlZBIuChNpc19wYXlvdXRfZmluYWxpemVkGCwgASgIUhFp'
    'c1BheW91dEZpbmFsaXplZBIhCgxpc19jb21wbGV0ZWQYISABKAhSC2lzQ29tcGxldGVkEigKEG'
    'NvbnRyYWN0X2FzX2pzb24YIiABKAlSDmNvbnRyYWN0QXNKc29uEj8KCGNvbnRyYWN0GCMgASgL'
    'MiMuaW8uaGF2ZW5vLnByb3RvYnVmZmVyLkNvbnRyYWN0SW5mb1IIY29udHJhY3QSIQoMdHJhZG'
    'Vfdm9sdW1lGCQgASgJUgt0cmFkZVZvbHVtZRItChNtYWtlcl9kZXBvc2l0X3R4X2lkGCUgASgJ'
    'UhBtYWtlckRlcG9zaXRUeElkEi0KE3Rha2VyX2RlcG9zaXRfdHhfaWQYJiABKAlSEHRha2VyRG'
    'Vwb3NpdFR4SWQSIAoMcGF5b3V0X3R4X2lkGCcgASgJUgpwYXlvdXRUeElkEh0KCnN0YXJ0X3Rp'
    'bWUYKCABKARSCXN0YXJ0VGltZRImCg9tYXhfZHVyYXRpb25fbXMYKSABKARSDW1heER1cmF0aW'
    '9uTXMSIwoNZGVhZGxpbmVfdGltZRgqIAEoBFIMZGVhZGxpbmVUaW1l');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.BalancesInfo',
      '10': 'balances'
    },
  ],
};
...
final $typed_data.Uint8List getXmrSeedRequestDescriptor =
    $convert.base64Decode('ChFHZXRYbXJTZWVkUmVxdWVzdA==');
...
final $typed_data.Uint8List getXmrSeedReplyDescriptor = $convert
    .base64Decode('Cg9HZXRYbXJTZWVkUmVwbHkSEgoEc2VlZBgBIAEoCVIEc2VlZA==');
...
final $typed_data.Uint8List getXmrPrimaryAddressRequestDescriptor =
    $convert.base64Decode('ChtHZXRYbXJQcmltYXJ5QWRkcmVzc1JlcXVlc3Q=');
...
final $typed_data.Uint8List getXmrPrimaryAddressReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getXmrNewSubaddressRequestDescriptor =
    $convert.base64Decode('ChpHZXRYbXJOZXdTdWJhZGRyZXNzUmVxdWVzdA==');
...
final $typed_data.Uint8List getXmrNewSubaddressReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getXmrTxsRequestDescriptor =
    $convert.base64Decode('ChBHZXRYbXJUeHNSZXF1ZXN0');
...
const XmrTx$json = {
  ...
  '2': [
    ...
    {
      '1': 'incoming_transfers',
      '3': 7,
      '4': 3,
      '5': 11,
      '6': '.io.haveno.protobuffer.XmrIncomingTransfer',
      '10': 'incomingTransfers'
    },
    {
      '1': 'outgoing_transfer',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.XmrOutgoingTransfer',
      '10': 'outgoingTransfer'
    },
...
const XmrIncomingTransfer$json = {
  ...
  '2': [
    ...
    {
      '1': 'num_suggested_confirmations',
      '3': 5,
      '4': 1,
      '5': 4,
      '10': 'numSuggestedConfirmations'
    },
  ],
};
...
const XmrOutgoingTransfer$json = {
  ...
  '2': [
    ...
    {'1': 'account_index', '3': 2, '4': 1, '5': 5, '10': 'accountIndex'},
    {
      '1': 'subaddress_indices',
      '3': 3,
      '4': 3,
      '5': 5,
      '10': 'subaddressIndices'
    },
    {
      '1': 'destinations',
      '3': 4,
      '4': 3,
      '5': 11,
      '6': '.io.haveno.protobuffer.XmrDestination',
      '10': 'destinations'
    },
  ],
};
...
@$core.Deprecated('Use createXmrSweepTxsRequestDescriptor instead')
const CreateXmrSweepTxsRequest$json = {
  '1': 'CreateXmrSweepTxsRequest',
  '2': [
    {'1': 'address', '3': 1, '4': 1, '5': 9, '10': 'address'},
  ],
};

/// Descriptor for `CreateXmrSweepTxsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createXmrSweepTxsRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVYbXJTd2VlcFR4c1JlcXVlc3QSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcw==');

@$core.Deprecated('Use createXmrSweepTxsReplyDescriptor instead')
const CreateXmrSweepTxsReply$json = {
  '1': 'CreateXmrSweepTxsReply',
  '2': [
    {
      '1': 'txs',
      '3': 1,
...
/// Descriptor for `CreateXmrSweepTxsReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createXmrSweepTxsReplyDescriptor =
    $convert.base64Decode(
        'ChZDcmVhdGVYbXJTd2VlcFR4c1JlcGx5Ei4KA3R4cxgBIAMoCzIcLmlvLmhhdmVuby5wcm90b2'
        'J1ZmZlci5YbXJUeFIDdHhz');

@$core.Deprecated('Use relayXmrTxsRequestDescriptor instead')
const RelayXmrTxsRequest$json = {
  '1': 'RelayXmrTxsRequest',
  '2': [
    {'1': 'metadatas', '3': 1, '4': 3, '5': 9, '10': 'metadatas'},
  ],
};

/// Descriptor for `RelayXmrTxsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List relayXmrTxsRequestDescriptor =
    $convert.base64Decode(
        'ChJSZWxheVhtclR4c1JlcXVlc3QSHAoJbWV0YWRhdGFzGAEgAygJUgltZXRhZGF0YXM=');

@$core.Deprecated('Use relayXmrTxsReplyDescriptor instead')
const RelayXmrTxsReply$json = {
  '1': 'RelayXmrTxsReply',
  '2': [
...
/// Descriptor for `RelayXmrTxsReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List relayXmrTxsReplyDescriptor = $convert
    .base64Decode('ChBSZWxheVhtclR4c1JlcGx5EhYKBmhhc2hlcxgCIAMoCVIGaGFzaGVz');
...
final $typed_data.Uint8List getAddressBalanceRequestDescriptor =
    $convert.base64Decode(
...
const GetAddressBalanceReply$json = {
  ...
  '2': [
    {
      '1': 'address_balance_info',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.AddressBalanceInfo',
      '10': 'addressBalanceInfo'
    },
  ],
};
...
final $typed_data.Uint8List getFundingAddressesRequestDescriptor =
    $convert.base64Decode('ChpHZXRGdW5kaW5nQWRkcmVzc2VzUmVxdWVzdA==');
...
final $typed_data.Uint8List setWalletPasswordRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List setWalletPasswordReplyDescriptor =
    $convert.base64Decode('ChZTZXRXYWxsZXRQYXNzd29yZFJlcGx5');
...
final $typed_data.Uint8List removeWalletPasswordRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List removeWalletPasswordReplyDescriptor =
    $convert.base64Decode('ChlSZW1vdmVXYWxsZXRQYXNzd29yZFJlcGx5');
...
final $typed_data.Uint8List lockWalletRequestDescriptor =
    $convert.base64Decode('ChFMb2NrV2FsbGV0UmVxdWVzdA==');
...
final $typed_data.Uint8List lockWalletReplyDescriptor =
    $convert.base64Decode('Cg9Mb2NrV2FsbGV0UmVwbHk=');
...
final $typed_data.Uint8List unlockWalletReplyDescriptor =
    $convert.base64Decode('ChFVbmxvY2tXYWxsZXRSZXBseQ==');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.BtcBalanceInfo',
      '10': 'btc'
    },
    {
      '1': 'xmr',
      ...
      '4': 1,
      '5': 11,
      '6': '.io.haveno.protobuffer.XmrBalanceInfo',
      '10': 'xmr'
    },
  ],
};
...
const BtcBalanceInfo$json = {
  ...
  '2': [
    ...
    {
      '1': 'total_available_balance',
      '3': 3,
      '4': 1,
      '5': 4,
      '10': 'totalAvailableBalance'
    },
...
@$core.Deprecated('Use getWalletHeightRequestDescriptor instead')
const GetWalletHeightRequest$json = {
  '1': 'GetWalletHeightRequest',
};

/// Descriptor for `GetWalletHeightRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWalletHeightRequestDescriptor =
    $convert.base64Decode('ChZHZXRXYWxsZXRIZWlnaHRSZXF1ZXN0');

@$core.Deprecated('Use getWalletHeightReplyDescriptor instead')
const GetWalletHeightReply$json = {
  '1': 'GetWalletHeightReply',
  '2': [
    {'1': 'height', '3': 1, '4': 1, '5': 3, '10': 'height'},
    {'1': 'target_height', '3': 2, '4': 1, '5': 3, '10': 'targetHeight'},
  ],
};

/// Descriptor for `GetWalletHeightReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWalletHeightReplyDescriptor = $convert.base64Decode(
    'ChRHZXRXYWxsZXRIZWlnaHRSZXBseRIWCgZoZWlnaHQYASABKANSBmhlaWdodBIjCg10YXJnZX'
    'RfaGVpZ2h0GAIgASgDUgx0YXJnZXRIZWlnaHQ=');
